...
const AppHeading = ({ sno, title }) => {
  return (
    ...
    >
      ...
      <h1 className="text-4xl md:text-5xl lg:text-8xl font-black text-dark tracking-tighter leading-[0.9] mb-8 relative">
      ...
      <div className="flex items-center gap-3">
        <motion.div
          ...
          className="h-1.5 w-32 bg-gradient-to-r from-primary to-purple-500 rounded-full origin-left shadow-sm"
        />
        <motion.div 
