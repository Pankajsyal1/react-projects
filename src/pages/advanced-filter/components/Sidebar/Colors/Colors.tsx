...
const Colors = ({ handleChange }) => {
  return (
    <div>
      <h2 className="text-[10px] font-black uppercase tracking-[0.3em] text-dark mb-6">Colors</h2>
      ...
      <div className="space-y-2">
        ...
        <Input handleChange={handleChange} value="black" title="Black" name="test1" color="#222" />
